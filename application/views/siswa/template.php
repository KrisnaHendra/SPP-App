...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #ff3d47;"> 
      ...
      <li class="nav-item">
        ...
        <a class="nav-link" href="<?= base_url('pembayaran/history') ?>">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Topbar -->
        <nav class="navbar navbar-fixed-top navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
